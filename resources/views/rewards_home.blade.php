...
@section('content')
    ...
    <div>
        ...
        <div class="pl-5 pt-2 pb-3">
            <x-button class="px-25" href="{{ $url }}?site=bing&type=news&unit=5&max=6&now=1">Daily検索</x-button>
        </div >
        <div class="pl-5 pt-2 pb-3">
            <x-button href="{{ $url }}?site=bing&type=search&unit=2&max=1&now=1">Bing 2検索</x-button>
            <x-button href="{{ $url }}?site=bing&type=search&unit=5&max=6&now=1">Bing 5x6検索</x-button>
            <x-button href="{{ $url }}?site=bing&type=news&unit=2&max=1&now=1">NEWS 2検索</x-button>
            <x-button href="{{ $url }}?site=bing&type=news&unit=5&max=1&now=1">NEWS 5検索</x-button>
        </div >
        <!-- <div class="pl-5 pb-5">
            <x-button href="{{ $url }}?site=rakuten&unit=2&max=1&now=1">楽天 2検索</x-button>
            <x-button href="{{ $url }}?site=rakuten&unit=2&max=2&now=1">楽天 3x10検索</x-button>
